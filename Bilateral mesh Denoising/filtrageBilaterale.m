...
% ou bien couleur.
if size(A,3) == 1
   reponse = Filtrage_Bilaterale_niveauxGRIS(A,w,sigma(1),sigma(2));
else
   reponse = Filtrage_Bilaterale_Couleur(A,w,sigma(1),sigma(2));
end


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Implementation du Filtrage Bilatérale pour l'image en niveau de gris.
function reponse = Filtrage_Bilaterale_niveauxGRIS(A,w,sigma_d,sigma_r)
...
function reponse = Filtrage_Bilaterale_Couleur(A,w,sigma_d,sigma_r)
