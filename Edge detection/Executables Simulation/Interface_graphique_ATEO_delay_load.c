 ...
 */
FARPROC WINAPI Interface_graphique_ATEODelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = Interface_graphique_ATEODelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = Interface_graphique_ATEODelayLoadWin32FailureHook;
#endif
